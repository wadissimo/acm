...
public class HCC18E2_TEST {
InputStream is;
PrintWriter out;
String INPUT = "2 5 1 5 7 11 14";
...
void solve()
{
    ...
    for(int i = 0;i < K;i++){
        ...
        System.out.println("argmin.v = " + argmin.v);
...
public static void main(String[] args) throws Exception { new HCC18E2_TEST().run(); }
